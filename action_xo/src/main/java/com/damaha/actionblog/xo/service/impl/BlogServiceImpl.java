...
import com.damaha.actionblog.base.enums.*;
import com.damaha.actionblog.commons.entity.*;
...
import com.damaha.actionblog.xo.mapper.BlogMapper;
import com.damaha.actionblog.xo.mapper.BlogSortMapper;
import com.damaha.actionblog.xo.mapper.TagMapper;
import com.damaha.actionblog.xo.service.*;
...
public class BlogServiceImpl extends SuperServiceImpl<BlogMapper, Blog> implements BlogService {
    ...
    public String editBatch(List<BlogVO> blogVOList) {
        ...
        if (save) {
            ...
            //发送到RabbitMq
            rabbitTemplate.convertAndSend(SysConf.EXCHANGE_DIRECT, SysConf.ACTION_BLOG, map);
        }
