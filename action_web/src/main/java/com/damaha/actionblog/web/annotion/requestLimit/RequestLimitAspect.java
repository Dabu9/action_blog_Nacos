package com.damaha.actionblog.web.annotion.requestLimit;

import com.damaha.actionblog.utils.AspectUtil;
...
public class RequestLimitAspect {
    ...
    private final String POINT = "execution(* com.damaha.actionblog.web.restapi..*.*(..))";
    @Autowired
