...
import com.damaha.actionblog.web.global.MessageConf;
import com.damaha.actionblog.web.global.RedisConf;
import com.damaha.actionblog.web.global.SQLConf;
import com.damaha.actionblog.web.global.SysConf;
import com.damaha.actionblog.commons.entity.Feedback;
import com.damaha.actionblog.commons.entity.Link;
import com.damaha.actionblog.commons.entity.SystemConfig;
import com.damaha.actionblog.commons.entity.User;
import com.damaha.actionblog.commons.feign.PictureFeignClient;
import com.damaha.actionblog.utils.*;
import com.damaha.actionblog.xo.service.*;
import com.damaha.actionblog.xo.utils.RabbitMqUtil;
import com.damaha.actionblog.xo.utils.WebUtil;
import com.damaha.actionblog.xo.vo.FeedbackVO;
import com.damaha.actionblog.xo.vo.LinkVO;
import com.damaha.actionblog.xo.vo.UserVO;
import com.damaha.actionblog.base.enums.EGender;
import com.damaha.actionblog.base.enums.ELinkStatus;
...
public class AuthRestApi {
    ...
    public String updateUserPwd(HttpServletRequest request, @RequestParam(value = "oldPwd") String oldPwd, @RequestParam("newPwd") String newPwd) {
        ...
        User user = userService.getById(userUid);
        // 判断是否是第三方登录的账号
        if (!user.getSource().equals(SysConf.ACTION)) {
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(actionWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(actionWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(actionWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
