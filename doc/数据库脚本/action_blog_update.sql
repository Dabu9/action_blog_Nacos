...
insert into `t_web_navbar` (`uid`, `name`, `navbar_level`, `summary`, `parent_uid`, `url`, `icon`, `is_show`, `is_jump_external_url`, `sort`, `status`, `create_time`, `update_time`) values('18118fb6fc0e5678495559e135ef754e','阿盛圈','1','阿盛圈',NULL,'/moment','el-icon-ice-cream','1','0','6','1','2021-12-26 16:11:25','2021-12-26 16:11:40');
...
insert  into `t_room`(`uid`,`room_type`,`belong_user_id`,`receive_id`,`avatar`,`title`,`session_id`,`status`,`create_time`,`update_time`) values ('10001',10002,'10000','10001','http://picture.moguit.cn//blog/admin/jpg/2020/12/21/1608539694443.jpg','阿盛社区交流群','10001',1,NULL,NULL);
...
热搜白名单
 */
INSERT INTO `t_sys_params`(`uid`, `params_type`, `params_name`, `params_key`, `remark`, `params_value`, `status`, `create_time`, `update_time`, `sort`) VALUES ('16f04204768bc80eef70d9bcfe1c049a', '1', '热搜白名单', 'SYS_WHITELIST_WORD', '热搜白名单', '一键部署,阿盛博客,', 1, '2022-06-20 17:05:57', '2022-06-20 17:05:57', 40);
...
/*
	...
	2022年8月7日07:53:12
*/
insert into `t_web_navbar` (`uid`, `name`, `navbar_level`, `summary`, `parent_uid`, `url`, `icon`, `is_show`, `is_jump_external_url`, `sort`, `status`, `create_time`, `update_time`) values('704f10018dea3a73ff51cdf2232f6bfe','热搜','1','阿盛热搜',NULL,'/hot','el-icon-umbrella','1','0','0','1','2022-08-06 15:28:02','2022-08-06 15:28:02');
