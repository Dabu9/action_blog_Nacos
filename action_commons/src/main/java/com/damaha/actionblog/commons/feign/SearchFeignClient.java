package com.damaha.actionblog.commons.feign;

import com.damaha.actionblog.commons.config.feign.FeignConfiguration;
import com.damaha.actionblog.commons.fallback.SearchFeignFallback;
 ...
 */
@FeignClient(name = "action-search", contextId = "searchFeignClient", configuration = FeignConfiguration.class, fallback = SearchFeignFallback.class)
