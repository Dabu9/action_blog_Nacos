package com.damaha.actionblog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.damaha.actionblog.picture.service.*;
import com.damaha.actionblog.commons.entity.File;
import com.damaha.actionblog.commons.entity.FileSort;
import com.damaha.actionblog.commons.entity.SystemConfig;
import com.damaha.actionblog.picture.global.MessageConf;
import com.damaha.actionblog.picture.global.SQLConf;
import com.damaha.actionblog.picture.global.SysConf;
import com.damaha.actionblog.picture.mapper.FileMapper;
import com.damaha.actionblog.picture.service.*;
import com.damaha.actionblog.picture.util.AboutFileUtil;
import com.damaha.actionblog.picture.util.FeignUtil;
import com.damaha.actionblog.utils.FileUtils;
import com.damaha.actionblog.utils.JsonUtils;
import com.damaha.actionblog.utils.ResultUtil;
import com.damaha.actionblog.utils.StringUtils;
import com.damaha.actionblog.base.enums.EFilePriority;
import com.damaha.actionblog.base.enums.EOpenStatus;
import com.damaha.actionblog.base.enums.EStatus;
import com.damaha.actionblog.base.exception.exceptionType.InsertException;
import com.damaha.actionblog.base.global.Constants;
import com.damaha.actionblog.base.global.ErrorCode;
import com.damaha.actionblog.base.holder.RequestHolder;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.damaha.actionblog.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.damaha.actionblog.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.damaha.actionblog.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String batchUploadFile(HttpServletRequest request, List<MultipartFile> filedatas, SystemConfig systemConfig) {
        ...
        if (SysConf.PICTURE.equals(source)) {
            // 当从vue-action-web网站过来的，直接从参数中获取
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.damaha.actionblog.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.damaha.actionblog.commons.entity.File file = new com.damaha.actionblog.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
